...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('/public/assets/img/icon.png')}}">
    <title>
        Quản lý sinh viên
    </title>
    <!-- Fonts and icons -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{route('index')}}">
                <img src="{{asset('/public/assets/img/logogw.png')}}" class="navbar-brand-img h-100" alt="main_logo">
